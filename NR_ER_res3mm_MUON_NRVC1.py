...
root_files_directory = '/Users/alexkish/data/MC/muons/Muons-3.3/raw/'
...
newfile = TFile(root_files_directory + root_file[:-5] + '-NR-ER-res3mm_NRVC1.root', 'recreate')
newtree = TTree('t2', '')
...
for entry in range(500):
	...
	all_steps = [[tree_ed[step], [tree_xp[step], tree_yp[step], tree_zp[step]], tree_type[step], tree_creaproc[step], tree_edproc[step]] for step in range(tree.nsteps)]
