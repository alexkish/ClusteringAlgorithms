...
#DATA PATH
#schroedinger
root_files_directory = '/home/physik/alexkish/data/Xe100_AmBe-STD_5e5/'
#xecluster
...
newfile = TFile(root_files_directory + root_file[:-5] + '-NRel-res3mm.root', 'recreate')
newtree = TTree('t2', '')
...
#for entry in range(1000):
	...
	filter_er = lambda p: p[2][:2]=='Xe' and p[3]=='HadronElastic'
