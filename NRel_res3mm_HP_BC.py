...
sensitive_volume_length = 353.5 # mm
...
newfile = TFile(root_files_directory + root_file[:-5] + '-NRel-res3mm_BC.root', 'recreate')
newtree = TTree('t2', '')
...
#for entry in range(1000):
	...
	filter_er = lambda p: p[2][:2]=='Xe' and p[3]=='hElastic'
